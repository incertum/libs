...
class filter_parser_escape_test : public testing::Test
{
protected:
...
TEST_F(filter_parser_escape_test, spaces)
{
...
TEST_F(filter_parser_escape_test, spaces_bidirectional)
{
	std::string in = "some string";
...
TEST_F(filter_parser_escape_test, ws_chars)
{
...
TEST_F(filter_parser_escape_test, ws_chars_bidirectional)
{
	std::string in = "some\\b\\f\\n\\r\\tstring";
...
TEST_F(filter_parser_escape_test, double_quotes)
{
...
TEST_F(filter_parser_escape_test, double_quotes_bidirectional)
{
	std::string in = "some \"quoted string\"";
...
TEST_F(filter_parser_escape_test, single_quotes)
{
	std::string in = "some 'quoted string'";
	std::string out = "\"some \\\"quoted string\\\"\"";
...
TEST_F(filter_parser_escape_test, single_quotes_bidirectional)
{
	std::string in = "some 'quoted string'";
	std::string out = "some \"quoted string\"";
